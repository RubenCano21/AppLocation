...
class editable_wheel(Command):
    ...
    def _select_strategy(
        ...
        if set(self.package_dir) == {""} and has_simple_layout or is_compat_mode:
            # api-layout(ish) is relatively safe for a simple pth file
...
def _simple_layout(
    ...
    >>> _simple_layout(['a'], {"": "api"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {"": "api"}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.b'], {}, "/tmp/myproj")
    True
    >>> _simple_layout(['a', 'a.a1', 'a.a1.a2', 'b'], {"": "api"}, "/tmp/myproj")
    True
    ...
    False
    >>> _simple_layout(['a', 'a.b'], {"": "api", "a.b": "_ab"}, "/tmp/myproj")
    False
    >>> # Special cases, no packages yet:
    >>> _simple_layout([], {"": "api"}, "/tmp/myproj")
    True
    >>> _simple_layout([], {"a": "_a", "": "api"}, "/tmp/myproj")
    False
    """
    layout = {
...
def _parent_path(pkg, pkg_path):
    ...
    own path.
    >>> _parent_path("a", "api/a")
    'api'
    >>> _parent_path("b", "api/c")
    'api/c'
    """
